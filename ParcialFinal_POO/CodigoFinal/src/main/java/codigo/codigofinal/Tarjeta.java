...
public class Tarjeta { // 00043823 Declaracion de la clase Tarjeta.
    ...
    public Tarjeta(int idTarjeta, String numeroTarjeta, LocalDate fechaExpiracion, String tipoTarjeta, String facilitador, int idCliente) { // 00043823 Constructor con parametros de la clase Tarjeta.
        this.idTarjeta = idTarjeta; // 00043823 El idTarjeta de la clase tomará el valor del idTarjeta que le pasen en el parametro.
        this.numeroTarjeta = numeroTarjeta; // 00043823 El numeroTarjeta de la clase tomará el valor del numeroTarjeta que le pasen en el parametro.
        this.fechaExpiracion = fechaExpiracion; // 00043823 El fechaExpiracion de la clase tomará el valor del fechaExpiracion que le pasen en el parametro.
        this.tipoTarjeta = tipoTarjeta; // 00043823 El tipoTarjeta de la clase tomará el valor del tipoTarjeta que le pasen en el parametro.
        this.facilitador = facilitador; // 00043823 El facilitador de la clase tomará el valor del facilitador que le pasen en el parametro.
        this.idCliente = idCliente; // 00043823 El idCliente de la clase tomará el valor del idCliente que le pasen en el parametro.
    }
    ...
    public void setIdTarjeta(int idTarjeta) { // 00043823 Metodo setter de la variable idTarjeta con el parametro idTarjeta.
        this.idTarjeta = idTarjeta; // 00043823 En este la varible idTarjeta de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setNumeroTarjeta(String numeroTarjeta) {// 00043823 Metodo setter de la variable numeroTarjeta con el parametro numeroTarjeta.
        this.numeroTarjeta = numeroTarjeta; // 00043823 En este la varible numeroTarjeta de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setFechaExpiracion(LocalDate fechaExpiracion) { // 00043823 Metodo setter de la variable fechaExpiracion con el parametro fechaExpiracion.
        this.fechaExpiracion = fechaExpiracion; // 00043823 En este la varible fechaExpiracion de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setTipoTarjeta(String tipoTarjeta) { // 00043823 Metodo setter de la variable tipoTarjeta con el parametro tipoTarjeta.
        this.tipoTarjeta = tipoTarjeta; // 00043823 En este la varible tipoTarjeta de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setFacilitador(String facilitador) { // 00043823 Metodo setter de la variable facilitador con el parametro facilitador.
        this.facilitador = facilitador; // 00043823 En este la varible facilitador de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setIdCliente(int idCliente) { // 00043823 Metodo setter de la variable idCliente con el parametro idCliente.
        this.idCliente = idCliente; // 00043823 En este la varible idCliente de la clase tomará el valor del parametro que le pasen.
    }
}
