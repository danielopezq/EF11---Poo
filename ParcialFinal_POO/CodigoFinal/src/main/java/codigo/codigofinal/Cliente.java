...
public class Cliente { // 00043823 Declaracion de la clase Cliente.
    ...
    public Cliente(int idCliente, String nombre, String direccion, String telefono) { // 00043823 Constructor con parametros de la clase Cliente.
        ...
        this.nombre = nombre; // 00043823 El nombre de la clase tomará el valor del nombre que le pasen en el parametro.
        this.direccion = direccion; // 00043823 La direccion de la clase tomará el valor de la direccion que le pasen en el parametro.
        this.telefono = telefono; // 00043823 El telefono de la clase tomará el valor del telefono que le pasen en el parametro.
    }
    ...
    public void setNombre(String nombre) { // 00043823 Metodo setter de la variable nombre con el parametro nombre.
        this.nombre = nombre;  // 00043823 En este la varible nombre de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setDireccion(String direccion) { // 00043823 Metodo setter de la variable direccion con el parametro direccion.
        this.direccion = direccion; // 00043823 En este la varible direccion de la clase tomará el valor del parametro que le pasen.
    }
    ...
    public void setTelefono(String telefono) { // 00043823 Metodo setter de la variable telefono con el parametro telefono.
        this.telefono = telefono; // 00043823 En este la varible telefono de la clase tomará el valor del parametro que le pasen.
    }
}
