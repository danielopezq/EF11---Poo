...
public class Compra { // 00043823 Declaracion de la clase Compra.
    ...
    public Compra(int idCompra, String fechaCompra, double montoTotal, String descripcion) { // 00043823 Constructor con parametros de la clase Compra.
        this.idCompra = idCompra; // 00043823 El idCompra de la clase tomara el valor del idCompra que le pasen en el parametro.
        this.fechaCompra = fechaCompra; // 00043823 La fechaCompra de la clase tomara el valor de la fechaCompra que le pasen en el parametro.
        this.montoTotal = montoTotal; // 00043823 El montoTotal de la clase tomara el valor del montoTotal que le pasen en el parametro.
        this.descripcion = descripcion; // 00043823 La descripcion de la clase tomara el valor de la descripcion que le pasen en el parametro.
    }
    ...
    public void setIdCompra(int idCompra) { // 00043823 Metodo setter de la variable idCompra con el parametro idCompra.
        this.idCompra = idCompra; // 00043823 En este la varible idCompra de la clase tomara el valor del parametro que le pasen.
    }
    ...
    public void setFechaCompra(String fechaCompra) { // 00043823 Metodo setter de la variable fechaCompra con el parametro fechaCompra.
        this.fechaCompra = fechaCompra; // 00043823 En este la varible fechaCompra de la clase tomara la cadena de texto del parametro que le pasen.
    }
    ...
    public void setMontoTotal(double montoTotal) { // 00043823 Metodo setter de la variable montoTotal con el parametro montoTotal.
        this.montoTotal = montoTotal; // 00043823 En este la varible montoTotal de la clase tomara el valor del parametro que le pasen.
    }
    ...
    public void setDescripcion(String descripcion) { // 00043823 Metodo setter de la variable descripcion con el parametro descripcion.
        this.descripcion = descripcion; // 00043823 En este la varible descripcion de la clase tomara la cadena de texto del parametro que le pasen.
    }
}
