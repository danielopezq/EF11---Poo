...
public class DatabaseConnection { //00043823 Nombre de la clase.
   private static final String URL = "jdbc:sqlserver://localhost:1433;databaseName=BCN;encrypt=true;trustServerCertificate=true;"; //00043823 Hago el atributo estatico y final porque será la misma URL, aquí hago la conexion de SQL Server a Java con mi BD llamada BCNN.
